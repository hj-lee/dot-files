# Keep $path deduplicated: every later addition here (and in ~/.zshrc, mise,
# brazil, etc.) can be a no-op re-prepend, and re-sourcing this file would
# otherwise grow PATH without bound. First occurrence wins, so prepending
# still overrides.
typeset -U path PATH
